...
<html class="dark">
  ...
  <body class="dark:bg-slate-900 ">
    ...
    <div class="sm:ml-64 ">
      <div
        class="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-800 text-gray-900  dark:text-white"
      >
        ...
        <div class="flex w-72 gap-2">
          ...
          <button
            id="theme-toggle"
            type="button"
            class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full text-sm p-2.5 w-"
          >
            <svg

  ...
  <body class="bg-slate-200 dark:bg-slate-900 ">
    ...
    <div class="sm:ml-64 ">
      ...
      <form method="POST" class="w-full my-4 ">
        ...
        <div class="relative overflow-x-auto p-3 bg-white dark:bg-slate-800 shadow-md sm:rounded-lg">
            <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
                ...
                <a href="includes/exportData.php" type="button" class="flex items-center justify-center flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-green-500 mr-2">
                    ...
                    <a href="../categories/importCate.php" class="flex gap-2 items-center justify-center flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-green-500">
                        ...
                        <div>Import Categories</div>
                    </a>
                    <a href="../categories/addCategories.php" class="flex gap-2 items-center justify-center flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400
                      dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-green-500">
            ...
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" colspan="2" class="px-6 py-2">
                            Action
                        </th>
                    </tr>
                </thead>
                <tbody id="search">
                    ...
                    if (mysqli_num_rows($categories) > 0) {
                       ...
                       <?php foreach($categories as $item) :?>
                        ...
                        <td class=" text-white flex items-center px-6 py-2">
                           <?php
                            if ($item['status'] == 1) {
                              echo "<p class='p-1 bg-green-500'>Active</p>";
                            }else {
                              echo "<p class='p-1 bg-red-500'>Active</p>";
                            }
                           ?>
                        </td>
                        <td class="px-6 py-2 ">
                            <a href="category_edit.php?id=<?= $item['id']?>" class=" font-medium text-gray-50 dark:text-white">
                        ...
                        <td class="px-6 py-2">
                            <a href="categoryDelete.php?id=<?= $item['id']?>" class="font-medium text-white dark:text-white">
     ...
     <script>
      ...
      $('#cateName').keyup(function(event){
          ...
          if(cateName != ''){
              ...
              $.ajax({
                  url: "../includes/cateSearch.php",
                  method: "POST",
                  data: {action:action,cateName:cateName},

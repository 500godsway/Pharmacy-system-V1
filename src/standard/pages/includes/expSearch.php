<?php
  ...
  $expName = $_POST['expName'];
   $product = "SELECT p.*, e.* FROM  products p, expenses e WHERE p.id = e.medId AND name LIKE '%$expName%' AND expenseType = 'Expired Medicine' ORDER BY e.medId DESC";
   ...
   if(mysqli_num_rows($result) > 0){
    ...
    ?>
<tr class="border-b dark:border-gray-600 bg-green-500 text-white hover:bg-green-400 dark:hover:bg-gray-700">
    ...
    <th scope="row" class="flex items-center px-4 py-2 font-medium  whitespace-nowrap dark:text-white">
        <img src="../../../pages/<?php echo $image;?>" alt="Drug Image" class="w-auto h-8 mr-3">
        <?php echo $name;?>
    </th>

...
<html class="dark">
  ...
  <body class="dark:bg-slate-900 bg-gray-100 dark:text-white text-gray-800">
    <button
                ...
                <div class="flex flex-col h-full">
                    ...
                    <div class="flex-grow p-5">
                        ...
                        <div class=" flex flex-col mt-2 border-t py-2 border-gray-600">
                            <div class="flex gap-3 justify-between">Email: <span class="text-green-500"><?php echo $email;?></span>
                            </div>
                            <div class="flex gap-3 justify-between items-center"> <span class="italic">Phone:</span> <span class="text-green-500"><?php echo $phone;?></span>
                            </div>
                        </div>
                    </div>
                    <!-- Card footer -->
                    <div class="border-t border-gray-600">
                        <div class="flex divide-x divide-gray-400r">
                          <a class="block flex-1 text-center text-sm text-red-600 hover:text-red-800 font-medium px-3 py-4" href="../../../authenticate/logout.php">
                            ...
                            class="block views flex-1 text-center text-sm dark:text-white text-gray-800 hover:text-green-500 font-medium px-3 py-4 group" href="#0">
                                <div class="flex items-center justify-center">
           ...
           <div class="max-w-sm mx-auto bg-gray-100 dark:bg-slate-800 shadow-lg rounded-md border border-gray-600">
                <div class="flex flex-col h-full">
                    ...
                    <div class="dark:bg-green-500 m-2">
                      <img src="../../../pages/<?= $phaInfo['image']?>" alt="">
                    </div>
                    <div class="flex-grow p-5">
                          ...
                          $today = date("Y-m-d", strtotime(date("Y-m-d")));
                            ...
                            ?>
                              <div class="flex gap-3 justify-between">Purchases <span class="text-red-500">-<!--Currency-->
                                  <span class="text-sm">
                                    <?php echo $profile['Currency'];?>
                                  </span><?php echo $content['buyingPrice'];?></span>
          ...
          <div class="max-w-sm mx-auto bg-gray-100 dark:bg-slate-800 shadow-lg rounded-md border border-gray-600">
                  <div class="flex flex-col h-full">
                      ...
                      <div class="flex-grow p-5">
                          ...
                          <!-- Info -->
                          <div class="mt-2 flex justify-center">
                              <div class="text-xs italic text-slate-400">This are the Mimimum quantites for pharmacy stock</div>
                          </div>
                          <!-- Accounts -->
                          <div class=" flex flex-col mt-2 border-t py-2 border-gray-600">
                          <?php
                      ...
                      <div class="border-t border-gray-600">
                          <div class="flex divide-x divide-gray-400r">
                              <p class="p-4">This is managed by the Admin</p>
                          </div>
                      </div>
                  </div>
              </div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
              ...
              <div class="mb-5">
                ...
                <input type="text" id="name" name="name" value="" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light"   />
              </div>
              <div class="mb-5">
                <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Email</label>
                <input type="email" id="email" name="email" value="" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light"  />
              </div>
              <div class="mb-5">
                <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone Number</label>
                <input type="text" id="phone" name="phone" value="" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light"  />
              </div>
              <div class="mb-5">
                <label for="location" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Location</label>
                <input type="text" id="text" name="location"  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light"  />
              </div>
              <div class="mb-5">
                <label for="Capital" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Inital Capital</label>
                <input type="text" id="text" name="capital"  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light"  />
              </div>
              <div class="mb-5">
                <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Profile Picture</label>
                <input type="file" id="text" name="image"  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light"  />
              ...
              <div class="mb-5">
                ...
                <input type="text" id="text" name="Currency"  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light"  />
              </div>
     ...
     <div id="quanities" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="mb-5">
              ...
              <input type="text" id="email" name="pharBal" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="Enter the minimum Qty required" />
            </div>
            <div class="mb-5">
              <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Total Sales</label>
              <input type="text" id="text" name="totalSales" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="Enter the minimum Qty required" requigreen />
            </div>
            <div class="mb-5">
              <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Total Sales Today</label>
              <input type="text" id="text" name="totalTSales" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="Enter the minimum Qty required" requigreen />
            </div>
            <div class="mb-5">
              <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sales Orders</label>
              <input type="text" id="text" name="salesOrders" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="Enter the minimum Qty required" requigreen />
            </div>
            <div class="mb-5">
              <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Invoice</label>
              <input type="text" id="text" name="invoices" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="Enter the minimum Qty required" requigreen />
            </div>
            <div class="mb-5">
              <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wastage</label>
              <input type="text" id="text" name="wastage" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="Enter the minimum Qty required" requigreen />
            </div>
            <div class="mb-5">
              <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Purchases</label>
              <input type="text" id="password" name="purchases" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="Enter the minimum Qty required" requigreen />
            </div>
            <div class="mb-5">
              <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Expired</label>
              <input type="text" id="text" name="expired" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="Enter the minimum Qty required" requigreen />
            </div>
            <div class="mb-5 col-span-2">
              <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Profit</label>
              <input type="text" id="text" name="profit" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500 dark:shadow-sm-light" placeholder="Enter the minimum Qty required" requigreen />
            </div>

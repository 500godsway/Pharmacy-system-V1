<section class="flex flex-col  justify-center antialiased w-full dark:text-white text-gray-600">
                ...
                <div class="flex-grow p-5">
                    <div class="flex justify-center">
                       ...
                       <div class="flex flex-col gap-2 items-center justify-center -mt-14">
                        ...
                        <span class="text-green-500 font-bold text-xl">Ksh<?= $phaInfo['initialCapital']?></span>
                        <?php endforeach?>
                       <?php
                    }else{
                        ?>

                       ...
                       <?php foreach($products as $productsItem) :?>
                        ...
                        <div class=" dark:border-slate-700 w-24 shadow-md">
                          <form action="../admins/invoiceAdd.php" method="POST">
                            <input type="text" name="productId" value="<?php echo $currency?>">
                          ...
                          <article class="relative flex flex-col overflow-hidden rounded-lg border bg-white dark:bg-gray-800">
                              ...
                              <img class="h-auto w-full object-cover transition-all duration-300 group-hover:scale-125" src="../../../pages/<?= $productsItem['image']?>" alt="" />
                              </div>
                            ...
                            ?>
                              ...
                              <div class="mb-1 flex">
                              <input  value="<?php echo $currency?><?= $productsItem['sPrice']?>.00" name="price"

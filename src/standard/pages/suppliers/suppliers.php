  ...
  <body class="bg-slate-200 dark:bg-slate-900 ">
    ...
    <?php 
      ...
      <div class="flex flex-col dark:text-white p-4">
        <div class="text-2xl">Suppliers</div>
      </div>
      <form method="POST" class="w-full mb-3">
            <label
              for="default-search"
    ...
    <?php 
              alertMessage();
            ?>
        <div class="flex flex-column bg-white dark:bg-slate-800 sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
            <div class="p-4">
            ...
            <div class="flex flex-col flex-shrink-0 space-y-3 px-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
            ...
            <a href="../suppliers/importSuppliers.php" class="flex gap-2 text-right justify-end flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
              ...
              <a href="addSuppliers.php" class="flex gap-2 w-full md:w-auto items-center justify-center flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-green-500">
                      <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 9a.75.75 0 0 0-1.5 0v2.25H9a.75.75 0 0 0 0 1.5h2.25V15a.75.75 0 0 0 1.5 0v-2.25H15a.75.75 0 0 0 0-1.5h-2.25V9Z" clip-rule="evenodd" />
                    </svg>
                      <div>Add Suppliers</div>
                </a>
              </div>
        </div>
            ...
            <?php foreach($suppliers as $item) :?>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class=" text-white flex items-center px-6 py-4">
                        <?php
                        if ($item['is_ban'] == 1) {
                            echo "<p class='p-2 bg-red-500'>Inactive</p>";
                        }else {
                            echo "<p class='p-2 bg-green-500'>Active</p>";
                        }
                        ?>
                    </td>
                    <td class="px-6 py-4 ">
                        <a href="supplierEdit.php?id=<?= $item['id']?>" class="font-medium text-white ">
                    ...
                    <td class="px-6 py-4">
                        <a href="deleteSupplier.php?id=<?= $item['id']?>" class="font-medium text-white ">
    ...
    <script>
      ...
      $('#supName').keyup(function(event){
          ...
          if(supName != ''){
              ...
              $.ajax({
                  url: "../includes/supSearch.php",
                  method: "POST",
                  data: {action:action,supName:supName},

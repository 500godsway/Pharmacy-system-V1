  ...
  <body class="bg-slate-200 dark:bg-slate-900 ">
    ...
    <?php 
      ...
      <div class="flex flex-col gap-4  w-full py-4 justify-center items-center ">
            <h2 class="text-2xl text-slate-800 dark:text-white">Add Customers</h2>
      <div class="flex w-1/2 bg-white border border-slate-400 dark:border-slate-700 justify-center rounded-md dark:bg-slate-800 p-4">    

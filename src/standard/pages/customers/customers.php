      ...
      <form method="POST" class="w-full my-4">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white dark:bg-slate-800">
            <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
                ...
                <div class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3 pr-4">
                ...
                <a href="../customers/importCustomers.php" class="flex gap-2 text-right justify-end flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-green-500">
                  ...
                  <a href="../customers/addCustomers.php" class="flex gap-2 w-full md:w-auto items-center justify-center flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-green-500">
                ...
                <tbody id="search">
                    ...
                    if (mysqli_num_rows($customers) > 0) {
                       ...
                       <?php foreach($customers as $custItem) :?>
                        ...
                        <td class="px-6 py-4">
                            <a href="custormers_edit.php?id=<?= $custItem['id']?>" class="font-medium text-white ">
                        ...
                        <td class="px-6 py-4">
                            <a href="custormers_delete.php?id=<?= $custItem['id']?>" class="font-medium text-white ">
    ...
    <script>
      ...
      $('#custName').keyup(function(event){
          ...
          if(custName != ''){
              ...
              $.ajax({
                  url: "../includes/custSearch.php",
                  method: "POST",
                  data: {action:action,custName:custName},

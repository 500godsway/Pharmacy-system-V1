          ...
          <?php 
              ...
              <div class="flex  -mx-3 my-3">
                <div class="w-full  px-3 cols-span-2">
                  ...
                  <img src="../<?= $product['data']['image'];?>" alt="productImage" class="w-10 h-10">
                </div>
                ...
                <div class="w-full md:w-1/2 px-3">
                  ...
                  <input <?= $product['data']['is_ban'] == true ? 'Checked' : '';?>  name="is_ban" type="checkbox" value="" class="w-5 h-5 text-green-500 bg-gray-100 border border-gray-700 rounded focus:ring-green-500 dark:focus:ring-green-500 dark:ring-offset-gray-800 focus:ring-2 dark:bg-slate-800 dark:border-gray-600 p-2">
                </div>
              </div>
              <div class="flex flex-wrap -mx-3 my-3">

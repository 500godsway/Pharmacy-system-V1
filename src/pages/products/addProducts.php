          ...
          <div class="flex flex-wrap -mx-3 my-3">
              ...
              <div class="flex flex-wrap -mx-3 my-3">
                ...
                <label class="block uppercase tracking-wide  text-xs font-bold mb-2" for="grid-first-name">
                  ...
                  id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 mySelect2 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white  ">
                    <option value="" >Choose Medicine Size</option>
                    <?php 
                      ...
                      if($units){
                              if (mysqli_num_rows($units)) {
                               foreach ($units as $unitItem) {
                                ...
                                echo '<option >No Medicine size Found</option>';
                              }
                      }else{
              ...
              <div class="flex flex-wrap -mx-3 my-3">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-2">
                  ...
                  <select name="supplierId"
                  id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white  ">
                ...
                <div class="w-full md:w-1/2 px-3">
                  ...
                  <input name="is_ban" type="checkbox" value="" class="w-5 h-5 text-green-500 bg-gray-100 border border-gray-700 rounded focus:ring-green-500 dark:focus:ring-green-500 dark:ring-offset-gray-800 focus:ring-2 dark:bg-slate-800 dark:border-gray-600 p-2">
                </div>
              </div>

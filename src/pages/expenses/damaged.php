  ...
  <body class="bg-slate-200 dark:bg-slate-900 ">
    ...
    <div class="sm:ml-64 ">
      ...
      <div class="flex flex-col dark:text-white p-4">
        <div class="text-2xl">Damaged Medicine</div>
      </div>
      ...
      <section class=" w-full overflow-x-auto  dark:bg-gray-900 py-3 sm:py-5">
              ...
              <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                  <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                      <div class="flex items-center flex-1 space-x-4">
                          ...
                          <h5>
                              <span class="text-gray-500">Total Damaged Medicine:</span>
                              <?php 
                  ...
                  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    //global $rows_per_page;
                      $count = getCountCriteria('expenses');
                      $pages = ceil($count / $rows_per_page);
                     //echo $page;

                    $query = "SELECT p.*, e.* FROM  products p, expenses e WHERE p.id = e.medId  AND expenseType = 'Damaged' ORDER BY e.medId ";
                    ...
                    <tbody id="search">
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <th scope="row" class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <img src="../<?= $expenseItem['image'];?>" alt="Drug Image" class="w-auto h-8 mr-3">
                                <?= $expenseItem['name']?>
                            </th>
                            ...
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center">
                                    ...
                                    <?= $expenseItem['price'] * $expenseItem['Qty'];?>
                                </div>
                            </td>
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $expenseItem['note']?></td>
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                              <a href="archive.php?medId=<?= $expenseItem['medId'];?>" class="bg-green-500 p-2">Archive</a>
                            </td>
                        </tr>
                    </tbody>
                    <?php endforeach?>
    ...
    <script>
     ...
     <script>
      ...
      $('#damageName').keyup(function(event){
          ...
          if(damageName != ''){
              ...
              $.ajax({
                  url: "../includes/damageSearch.php",
                  method: "POST",
                  data: {action:action,damageName:damageName},

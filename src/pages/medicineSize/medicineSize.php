    ...
    <div class="sm:ml-64 ">
      ...
      <div class="flex flex-col dark:text-white p-4">
         <?php 
              alertMessage();
            ?>
        <div class="text-2xl">Dose-form </div>
      </div>
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-3 ">
            <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
                ...
                <a href="importMedSize.php" class="flex gap-2 items-center justify-center flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 text-green-500">
                      ...
                      <div>Import Dose-form </div>
                </a>
                <a href="medicineSizeAdd.php" class="flex gap-2 items-center justify-center flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400
                    dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($units) > 0) {
                       ...
                       <?php foreach($units as $item) :?>
                        ...
                        <td class="px-6 py-2">
                            <a href="unitsEdit.php?id=<?= $item['id']?>" class=" font-medium text-white dark:text-white">
                        ...
                        <td class="px-6 py-2">
                            <a href="unitsDelete.php?id=<?= $item['id']?>" class=" font-medium text-white dark:text-white">

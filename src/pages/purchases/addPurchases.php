                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                 ...
                 <input name="buyingPrice" onclick="subtract()" id="buyingPrice"
                  class="appearance-none block w-full bg-white
                   dark:bg-gray-800 border border-slate-400
                    dark:border-gray-700  rounded py-3 px-4 mb-3 
                    leading-tight focus:outline-none
                    "id="grid-first-name" type="text" placeholder=" Buying P">
                </div>
                <div class="w-full md:w-1/2 px-3">
                  <label class="block uppercase tracking-wide  text-xs font-bold mb-2" for="grid-last-name">
                    Selling Price
                  ...
                  class="appearance-none block w-full
                   bg-white dark:bg-gray-800 border
                    ...
                    rounded py-3 px-4 leading-tight focus:outline-none
                     " id="grid-last-name" type="text" placeholder=" Selling P">
                </div>
                <div class="w-full md:w-1/2 px-3"> 
                  <label class="block uppercase tracking-wide  text-xs font-bold mb-2" for="grid-last-name">
                   Profit

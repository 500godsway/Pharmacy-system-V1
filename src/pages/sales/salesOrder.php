...
<html class="dark">
  ...
  <body class="bg-slate-200 dark:bg-slate-900 ">
    <button
      ...
      type="button"
      class="inline-flex items-center p-2 mt-2 ms-3 text-sm  rounded-lg sm:hidden hover:bg-white focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
    >
        ...
        <div class="grid lg:grid-cols-2 w-full mb-5">
            ...
            <section class=" py-12 text-gray-700  ">
                <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                    ...
                    <!-- search-->
                    <div class="text-gray-800 dark:text-white text-4xl">Sales Order</div>
                    <!-- search-->
                    </div>
                    <div class="mt-10  lg:mt-16 border border-slate-400 dark:border-slate-700 p-4 rounded-md">
                      <?php 
                        if (!isset($_SESSION['custDetails'])) {
                          $custName = "";
                        }else {
                          $custName = $_SESSION['custDetails']['cName'];
                        }
                      ?>
                      <?php 
                        if (!isset($_SESSION['custDetails'])) {
                          ...
                          $custEmail = $_SESSION['custDetails']['email'];
                        }
                      ?>
                      <?php 
                        if (!isset($_SESSION['custDetails'])) {
                          ...
                          $custPhone = $_SESSION['custDetails']['phone'];
                        }
                      ?>
                    <form  action="../includes/salesOrderAdd.php" method="POST" class="flex flex-col gap-4 text-gray-800 dark:text-gray-400">
                        <div class=" px-3">
                            ...
                            class=" appearance-none block w-full bg-white dark:bg-gray-800 border border-slate-400 dark:border-gray-700   rounded py-3 px-4 leading-tight focus:outline-none mySelect2" name="state">
                                ...
                                <?php
                                 $products = "SELECT * FROM products WHERE is_ban =0 ";
                        ...
                        <div class="flex -mx-3 mb-6">
                            ...
                            class=" appearance-none block w-full mySelect2 bg-white dark:bg-gray-800 border border-slate-400 dark:border-gray-700   rounded py-3 px-2 leading-tight focus:outline-none  dark:text-white" name="state">
                        ...
                        <p class="text-red-500 italic text-sm">Add the customer details only Once</p>
                        <div class="flex -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide  text-xs font-bold mb-2" for="grid-first-name">
                                    Customer Name
                        ...
                        <button type="submit" name="salesOderPlace" class="salesOderPlace mt-6 bg-green-600 p-2 text-white " id="salesOderPlace">Add Medicine </button>
                    </form>
                    </div>
                </div>
            </section>
            ...
            <div class="" > 
            <div  id="orderArea"
            class="max-w-3xl mx-auto px-6 py-2 mt-3 bg-white dark:bg-gray-900 " id="invoice">
            <!-- Invoice Items -->
            ...
            <!-- PHP code start here.. -->
                ...
                <tbody>
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="  max-w-0 py-5 pl-4 pr-3 text-sm sm:pl-0 ">
                        <div class="relative flex items-center quanitityBox">
                          <input type="hidden" value="<?= $item['orderId']?>" 
                              ...
                              class="reqId"/>
                              <button type="button"  
                              class="bg-white dark:bg-gray-900 pDecreament dark:hover:bg-gray-900 dark:border-gray-900 hover:bg-gray-200 border border-gray-300 rounded-s-lg   focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
                                  -
                              </button>
                              <input 
                              type="text" 
                              value="<?= $item['Qty']?>" 
                              class="bg-gray-50 border-x-0 p-2 qty qtyInput border-gray-300  text-center text-gray-900 text-sm focus:ring-blue-500 focus:outline-none block w-full  dark:bg-gray-900 dark:border-gray-900 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="999" required />
                              <button type="button"  class="bg-white  dark:bg-gray-900 pIncreament dark:hover:bg-gray-900 dark:border-gray-900 hover:bg-gray-200 border border-gray-300 rounded-e-lg  focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
                                  +
                              </button>
                          </div>
                            </td>
    ...
    <!-- PHP code end here.. -->
        ...
        <?php 
                        if (!isset($_SESSION['salesOrder'])) {
                          ...
                          ?>
                            <div class="fixed h-24 bottom-0  flex items-center  p-3 mt-2 gap-4 justify-center w-auto rounded-md bg-slate-200 dark:bg-gray-900 border border-slate-400 dark:border-slate-700 ">
                                <div class="reqDetails">
                                <label for="" class="block text-sm font-medium text-gray-900  dark:text-white">Prepared  by: </label>
                                <input type="text" value="<?= $_SESSION['loggedInUser']['name'];?>" id="username" aria-describedby="helper-text-explanation"  aria-label="disabled input" disabled class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-900 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                                </div>
                                <button type="button" class="continueToOrder mt-6 bg-blue-600 p-2 text-white " id="continueToOrder">Continue </button>
                            </div>
                          <?php
                        }
                      ?>
